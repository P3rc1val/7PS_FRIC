...
class FindingDetails extends Component {
  super(props){
    this.state = {
      ...
      MitigationLongDespcription: "",
      Relevance: "",
      CountermeasureEfectiveness: "",
      ImpactDescription: "",
      ImpactLevel: "",
      SeverityCode: "",
      SeverityScore: "",
      VulnerabilitySeverity: "",
      QuantitativeSeverity: "",
      Risk: "",
      RiskLikehood: "",
      ConfidentialityOnSystem: "",
      IntegrityOnSystem: "",
      AvailabilitySystem: "",
      ImpactScore: "",
    };
  ...
  async createFinding(Findigs){
    await fetch('http://localhost:8080/createFindings',{
      method: 'POST',
      headers: {
