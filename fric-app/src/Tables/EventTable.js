...
function createData(eventName, noOfSystems, noOfFindings, progress) {
  return { eventName, noOfSystems, noOfFindings, progress };
}

const rows = [
  createData("BobsEvent", 305, 3.7, 67),
  createData("MariosEvent", 452, 25.0, 51),
  createData("EricsEvent", 262, 16.0, 24),
];
...
export default function EnhancedTable(props) {
  // const rows = [];
  // const { createTable } = props.fetchEvent;

  // var col = [];
  // for (var i = 0; i < createTable.length; i++) {
  //   for (var key in createTable[i]) {
  ...
  // for (let i = 0; i < createTable.length; i += 1) {
  ...
  //     tabCell.innerHTML = createTable[i][col[j]];
  //     if (j == 0) {
  //       newEventName = createTable[i][col[j]];
  //     } else if (j == 1) {
  //       newnoOfSystems = createTable[i][col[j]];
  //     } else if (j == 2) {
  //       newNoOfFindings = createTable[i][col[j]];
  //     } else if (j == 3) {
  //       newProgrss = createTable[i][col[j]];
  //     }
  //   }
  //   createData(newEventName, newnoOfSystems, newNoOfFindings, newProgrss);
  // }

  const classes = useStyles();
  const [order, setOrder] = React.useState("asc");
  const [orderBy, setOrderBy] = React.useState("noOfSystems");
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">{row.noOfSystems}</TableCell>
